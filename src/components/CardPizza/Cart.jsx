...
import { clearItem, minusItem, removeItem } from "../../redux/slices/cartSlice";
      ...
      <div class="container container--cart">
        <div class="cart">
          <div class="cart__top">
            ...
            <div onClick={onClickClearProducts} class="cart__clear">
              <svg
                width="20"
                height="20"
                viewBox="0 0 20 20"
          ...
          <div class="cart__bottom">
            <div class="cart__bottom-details">
              <span>
                {" "}
                Всего товаров: <b>{totalPriceElse} шт.</b>{" "}
              </span>
              <span>
                {" "}
