...
import { addProducts, minusItem, removeItem } from "../redux/slices/cartSlice";

const CartItem = ({ id, price, title, types, sizes, imageUrl, count }) => {
  ...
  const onClickDeleteProduct = () => {
    if (window.confirm("Ты точно хочешь удалить этот продукт?")) {
